...
public class GoddessLongswordBeamEntityRenderer extends EntityRenderer<GoddessLongswordBeamEntity> {
    ...
    @Override
    public void render(@NotNull GoddessLongswordBeamEntity beam, float yaw, float tickDelta, @NotNull MatrixStack matrices, @NotNull VertexConsumerProvider vertexConsumers, int light) {
        matrices.push();
