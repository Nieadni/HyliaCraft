...
public class GoddessSwordBeamEntityRenderer extends EntityRenderer<GoddessSwordBeamEntity> {
    ...
    public GoddessSwordBeamEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
    }

    @Override
    public void render(@NotNull GoddessSwordBeamEntity beam, float yaw, float tickDelta, @NotNull MatrixStack matrices, @NotNull VertexConsumerProvider vertexConsumers, int light) {
        matrices.push();
    ...
    @Override
    public Identifier getTexture(@NotNull GoddessSwordBeamEntity beam) {
