...
public class TrueMasterSwordBeamEntity extends ProjectileEntity {
    ...
    private static final TrackedData<Boolean> VERTICAL = DataTracker.registerData(TrueMasterSwordBeamEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    ...
    private TrueMasterSwordBeamEntity(World world, float damage) {
        super(HCEntities.TRUE_MASTER_SWORD_BEAM, world);
        this.damage = damage;
    }

    public static TrueMasterSwordBeamEntity create(World world, float damage) {
        return new TrueMasterSwordBeamEntity(world, damage);
    }
