...
public class HCItems extends Items {
    ...
    // Equipment
    public static final Item BOKOBLIN_MASK = register(new BokoblinMaskItem(HCArmourMaterials.BOKOBLIN_MASK, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.BOKOBLIN_MASK_DURABILITY_MULTIPLIER))), "bokoblin_mask");
    ...
    public static final Item RAVIO_HOOD = register(new RavioHoodItem(HCArmourMaterials.RAVIO_HOOD, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.RAVIO_HOOD_DURABILITY_MULTIPLIER))), "ravio_hood");
    public static final Item ZANT_HELM = register(new ZantHelmItem(HCArmourMaterials.ZANT_HELM, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.ZANT_HELM_DURABILITY_MULTIPLIER)).fireproof().rarity(Rarity.EPIC)), "zant_helm");

    public static final Item ENGINEER_CAP = register(new EngineerClothingItem(HCArmourMaterials.ENGINEERS_ClOTHES, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.ENGINEERS_ClOTHES_DURABILITY_MULTIPLIER))), "engineer_cap");
    public static final Item ENGINEER_SHIRT = register(new EngineerClothingItem(HCArmourMaterials.ENGINEERS_ClOTHES, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(HCArmourMaterials.ENGINEERS_ClOTHES_DURABILITY_MULTIPLIER))), "engineer_shirt");
    public static final Item ENGINEER_TROUSERS = register(new EngineerClothingItem(HCArmourMaterials.ENGINEERS_ClOTHES, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(HCArmourMaterials.ENGINEERS_ClOTHES_DURABILITY_MULTIPLIER))), "engineer_trousers");
    public static final Item ENGINEER_BOOTS = register(new EngineerClothingItem(HCArmourMaterials.ENGINEERS_ClOTHES, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(HCArmourMaterials.ENGINEERS_ClOTHES_DURABILITY_MULTIPLIER))), "engineer_boots");
    public static final Item PHANTOM_HELMET = register(new PhantomHelmetItem(HCArmourMaterials.PHANTOM_ARMOR, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.PHANTOM_ARMOR_DURABILITY_MULTIPLIER)).fireproof().rarity(Rarity.EPIC)), "phantom_helmet");
    public static final Item PHANTOM_CHESTPLATE = register(new PhantomChestplateItem(HCArmourMaterials.PHANTOM_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(HCArmourMaterials.PHANTOM_ARMOR_DURABILITY_MULTIPLIER)).fireproof().rarity(Rarity.EPIC)), "phantom_chestplate");
    public static final Item PHANTOM_LEGGINGS = register(new PhantomArmorItem(HCArmourMaterials.PHANTOM_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(HCArmourMaterials.PHANTOM_ARMOR_DURABILITY_MULTIPLIER)).fireproof().rarity(Rarity.EPIC)), "phantom_leggings");
    public static final Item PHANTOM_BOOTS = register(new PhantomArmorItem(HCArmourMaterials.PHANTOM_ARMOR, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(HCArmourMaterials.PHANTOM_ARMOR_DURABILITY_MULTIPLIER)).fireproof().rarity(Rarity.EPIC)), "phantom_boots");
    public static final Item TINGLE_HOOD = register(new TingleHoodItem(HCArmourMaterials.TINGLES_ClOTHES, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.TINGLES_ClOTHES_DURABILITY_MULTIPLIER))), "tingle_hood");
    public static final Item TINGLE_SHIRT = register(new TingleClothingItem(HCArmourMaterials.TINGLES_ClOTHES, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(HCArmourMaterials.TINGLES_ClOTHES_DURABILITY_MULTIPLIER))), "tingle_shirt");
    public static final Item TINGLE_TIGHTS = register(new TingleClothingItem(HCArmourMaterials.TINGLES_ClOTHES, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(HCArmourMaterials.TINGLES_ClOTHES_DURABILITY_MULTIPLIER))), "tingle_tights");
    public static final Item TINGLE_BOOTS = register(new TingleClothingItem(HCArmourMaterials.TINGLES_ClOTHES, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(HCArmourMaterials.TINGLES_ClOTHES_DURABILITY_MULTIPLIER))), "tingle_boots");
