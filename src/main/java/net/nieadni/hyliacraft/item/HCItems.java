...
public class HCItems extends Items {
    ...
    public static final Item RAVIO_HOOD = register(new BokoblinMaskItem(HCArmourMaterials.RAVIO_HOOD, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.RAVIO_HOOD_DURABILITY_MULTIPLIER))), "ravio_hood");
    ...
    public static final Item PHANTOM_HELMET = register(new PhantomArmorItem(HCArmourMaterials.PHANTOM_ARMOR, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.PHANTOM_ARMOR_DURABILITY_MULTIPLIER))), "phantom_helmet");
    public static final Item PHANTOM_CHESTPLATE = register(new PhantomArmorItem(HCArmourMaterials.PHANTOM_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings().maxDamage(ArmorItem.Type.CHESTPLATE.getMaxDamage(HCArmourMaterials.PHANTOM_ARMOR_DURABILITY_MULTIPLIER))), "phantom_chestplate");
    public static final Item PHANTOM_LEGGINGS = register(new PhantomArmorItem(HCArmourMaterials.PHANTOM_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Settings().maxDamage(ArmorItem.Type.LEGGINGS.getMaxDamage(HCArmourMaterials.PHANTOM_ARMOR_DURABILITY_MULTIPLIER))), "phantom_leggings");
    public static final Item PHANTOM_BOOTS = register(new PhantomArmorItem(HCArmourMaterials.PHANTOM_ARMOR, ArmorItem.Type.BOOTS, new Item.Settings().maxDamage(ArmorItem.Type.BOOTS.getMaxDamage(HCArmourMaterials.PHANTOM_ARMOR_DURABILITY_MULTIPLIER))), "phantom_boots");
    public static final Item TINGLE_HOOD = register(new TingleClothingItem(HCArmourMaterials.TINGLES_ClOTHES, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.TINGLES_ClOTHES_DURABILITY_MULTIPLIER))), "tingle_hood");
