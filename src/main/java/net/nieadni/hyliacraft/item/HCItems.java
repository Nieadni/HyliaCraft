...
public class HCItems extends Items {
    ...
    public static final Item PHRYGIAN_CAP_TP = register(new PhrygianCapTPItem(HCArmourMaterials.PHRYGIAN_CAP_TP, ArmorItem.Type.HELMET, new Item.Settings().maxDamage(ArmorItem.Type.HELMET.getMaxDamage(HCArmourMaterials.PHRYGIAN_CAP_TP_DURABILITY_MULTIPLIER))), "phrygian_cap_tp");
