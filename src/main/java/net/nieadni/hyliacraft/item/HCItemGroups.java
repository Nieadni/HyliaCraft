    ...
    public static final ItemGroup COLOURED_BLOCKS_GROUP = Registry.register(Registries.ITEM_GROUP,
            ...
            FabricItemGroup.builder().displayName(Text.translatable("itemGroup.hyliacraft.coloured_blocks"))
                    .icon(() -> new ItemStack(HCColouredBlocks.RAINBOW_BRICKS)).entries((displayContext, entries) -> {
                        ...
                        entries.add(HCColouredBlocks.LIGHT_GRAY_BRICKS);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_BRICK_STAIRS);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_BRICK_SLAB);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_BRICK_WALL);
                        entries.add(HCColouredBlocks.GRAY_BRICKS);
                        entries.add(HCColouredBlocks.GRAY_BRICK_STAIRS);
                        entries.add(HCColouredBlocks.GRAY_BRICK_SLAB);
                        entries.add(HCColouredBlocks.GRAY_BRICK_WALL);
                        ...
                        entries.add(HCColouredBlocks.LIGHT_GRAY_STRIPPED_LOG);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_STRIPPED_WOOD);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_PLANKS);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_STAIRS);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_SLAB);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_FENCE);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_FENCE_GATE);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_PRESSURE_PLATE);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_BUTTON);
                        entries.add(HCColouredBlocks.GRAY_STRIPPED_LOG);
                        entries.add(HCColouredBlocks.GRAY_STRIPPED_WOOD);
                        entries.add(HCColouredBlocks.GRAY_PLANKS);
                        entries.add(HCColouredBlocks.GRAY_STAIRS);
                        entries.add(HCColouredBlocks.GRAY_SLAB);
                        entries.add(HCColouredBlocks.GRAY_FENCE);
                        entries.add(HCColouredBlocks.GRAY_FENCE_GATE);
                        entries.add(HCColouredBlocks.GRAY_PRESSURE_PLATE);
                        entries.add(HCColouredBlocks.GRAY_BUTTON);
                        ...
                        entries.add(HCColouredBlocks.LIGHT_GRAY_SHINGLES);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_SHINGLE_STAIRS);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_SHINGLE_SLAB);
                        entries.add(HCColouredBlocks.LIGHT_GRAY_SHINGLE_WALL);
                        entries.add(HCColouredBlocks.GRAY_SHINGLES);
                        entries.add(HCColouredBlocks.GRAY_SHINGLE_STAIRS);
                        entries.add(HCColouredBlocks.GRAY_SHINGLE_SLAB);
                        entries.add(HCColouredBlocks.GRAY_SHINGLE_WALL);
