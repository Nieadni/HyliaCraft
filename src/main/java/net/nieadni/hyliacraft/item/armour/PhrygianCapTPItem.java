...
import net.nieadni.hyliacraft.client.armour.PhrygianCapTPRenderer;
...
public class PhrygianCapTPItem extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public PhrygianCapTPItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                ...
                if (this.renderer == null)
                    this.renderer = new PhrygianCapTPRenderer();
    ...
    public void appendTooltip(ItemStack stack, TooltipContext context, @NotNull List<Text> tooltip, TooltipType type) {
        tooltip.add(Text.translatable("tooltip.hyliacraft.phrygian_cap_tp").formatted(Formatting.GRAY));
    }
