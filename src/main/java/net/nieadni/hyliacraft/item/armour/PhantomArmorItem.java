...
import net.nieadni.hyliacraft.client.armour.sets.PhantomGreavesRenderer;
...
public class PhantomArmorItem extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public PhantomArmorItem(RegistryEntry<ArmorMaterial> material, Type type, Settings settings) {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public @Nullable <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(@Nullable T livingEntity, ItemStack itemStack, @Nullable EquipmentSlot equipmentSlot, @Nullable BipedEntityModel<T> original) {
                ...
                if (this.renderer == null)
                    this.renderer = new PhantomGreavesRenderer();
