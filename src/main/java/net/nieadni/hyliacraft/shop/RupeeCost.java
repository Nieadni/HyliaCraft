 ...
 * @param maxUses trades allowed before the offer locks until the merchant restocks
 */
public record RupeeCost(Item item, int cost, List<Item> accepts, int maxUses) {
}
