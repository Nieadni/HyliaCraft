...
public class HCBlockLootProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(HCColouredBlocks.LIGHT_GRAY_BRICKS);
        addDrop(HCColouredBlocks.LIGHT_GRAY_BRICK_STAIRS);
        slabDrops(HCColouredBlocks.LIGHT_GRAY_BRICK_SLAB);
        addDrop(HCColouredBlocks.LIGHT_GRAY_BRICK_WALL);
        addDrop(HCColouredBlocks.GRAY_BRICKS);
        addDrop(HCColouredBlocks.GRAY_BRICK_STAIRS);
        slabDrops(HCColouredBlocks.GRAY_BRICK_SLAB);
        addDrop(HCColouredBlocks.GRAY_BRICK_WALL);
        ...
        addDrop(HCColouredBlocks.LIGHT_GRAY_STRIPPED_LOG);
        addDrop(HCColouredBlocks.LIGHT_GRAY_STRIPPED_WOOD);
        addDrop(HCColouredBlocks.LIGHT_GRAY_PLANKS);
        addDrop(HCColouredBlocks.LIGHT_GRAY_STAIRS);
        slabDrops(HCColouredBlocks.LIGHT_GRAY_SLAB);
        addDrop(HCColouredBlocks.LIGHT_GRAY_FENCE);
        addDrop(HCColouredBlocks.LIGHT_GRAY_FENCE_GATE);
        addDrop(HCColouredBlocks.LIGHT_GRAY_PRESSURE_PLATE);
        addDrop(HCColouredBlocks.LIGHT_GRAY_BUTTON);
        addDrop(HCColouredBlocks.GRAY_STRIPPED_LOG);
        addDrop(HCColouredBlocks.GRAY_STRIPPED_WOOD);
        addDrop(HCColouredBlocks.GRAY_PLANKS);
        addDrop(HCColouredBlocks.GRAY_STAIRS);
        slabDrops(HCColouredBlocks.GRAY_SLAB);
        addDrop(HCColouredBlocks.GRAY_FENCE);
        addDrop(HCColouredBlocks.GRAY_FENCE_GATE);
        addDrop(HCColouredBlocks.GRAY_PRESSURE_PLATE);
        addDrop(HCColouredBlocks.GRAY_BUTTON);
        ...
        addDrop(HCColouredBlocks.LIGHT_GRAY_SHINGLES);
        addDrop(HCColouredBlocks.LIGHT_GRAY_SHINGLE_STAIRS);
        slabDrops(HCColouredBlocks.LIGHT_GRAY_SHINGLE_SLAB);
        addDrop(HCColouredBlocks.LIGHT_GRAY_SHINGLE_WALL);
        addDrop(HCColouredBlocks.GRAY_SHINGLES);
        addDrop(HCColouredBlocks.GRAY_SHINGLE_STAIRS);
        slabDrops(HCColouredBlocks.GRAY_SHINGLE_SLAB);
        addDrop(HCColouredBlocks.GRAY_SHINGLE_WALL);
