...
public class HCItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        getOrCreateTagBuilder(HCItemTags.BRICKS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_BRICKS));
        getOrCreateTagBuilder(HCItemTags.BRICK_STAIRS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_BRICK_STAIRS));
        getOrCreateTagBuilder(HCItemTags.BRICK_SLABS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_BRICK_SLAB));
        getOrCreateTagBuilder(HCItemTags.BRICK_WALLS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_BRICK_WALL));
        getOrCreateTagBuilder(HCItemTags.BRICKS).add(Item.fromBlock(HCColouredBlocks.GRAY_BRICKS));
        getOrCreateTagBuilder(HCItemTags.BRICK_STAIRS).add(Item.fromBlock(HCColouredBlocks.GRAY_BRICK_STAIRS));
        getOrCreateTagBuilder(HCItemTags.BRICK_SLABS).add(Item.fromBlock(HCColouredBlocks.GRAY_BRICK_SLAB));
        getOrCreateTagBuilder(HCItemTags.BRICK_WALLS).add(Item.fromBlock(HCColouredBlocks.GRAY_BRICK_WALL));
        ...
        getOrCreateTagBuilder(HCItemTags.PLANKS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_PLANKS));
        getOrCreateTagBuilder(HCItemTags.STRIPPED_LOGS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_STRIPPED_LOG));
        getOrCreateTagBuilder(HCItemTags.STRIPPED_WOODS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_STRIPPED_WOOD));
        getOrCreateTagBuilder(HCItemTags.PLANK_STAIRS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_STAIRS));
        getOrCreateTagBuilder(HCItemTags.PLANK_SLABS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_SLAB));
        getOrCreateTagBuilder(HCItemTags.PLANK_FENCES).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_FENCE));
        getOrCreateTagBuilder(HCItemTags.PLANK_FENCE_GATES).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_FENCE_GATE));
        getOrCreateTagBuilder(HCItemTags.PLANK_PRESSURE_PLATES).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_PRESSURE_PLATE));
        getOrCreateTagBuilder(HCItemTags.PLANK_BUTTONS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_BUTTON));
        getOrCreateTagBuilder(HCItemTags.PLANKS).add(Item.fromBlock(HCColouredBlocks.GRAY_PLANKS));
        getOrCreateTagBuilder(HCItemTags.STRIPPED_LOGS).add(Item.fromBlock(HCColouredBlocks.GRAY_STRIPPED_LOG));
        getOrCreateTagBuilder(HCItemTags.STRIPPED_WOODS).add(Item.fromBlock(HCColouredBlocks.GRAY_STRIPPED_WOOD));
        getOrCreateTagBuilder(HCItemTags.PLANK_STAIRS).add(Item.fromBlock(HCColouredBlocks.GRAY_STAIRS));
        getOrCreateTagBuilder(HCItemTags.PLANK_SLABS).add(Item.fromBlock(HCColouredBlocks.GRAY_SLAB));
        getOrCreateTagBuilder(HCItemTags.PLANK_FENCES).add(Item.fromBlock(HCColouredBlocks.GRAY_FENCE));
        getOrCreateTagBuilder(HCItemTags.PLANK_FENCE_GATES).add(Item.fromBlock(HCColouredBlocks.GRAY_FENCE_GATE));
        getOrCreateTagBuilder(HCItemTags.PLANK_PRESSURE_PLATES).add(Item.fromBlock(HCColouredBlocks.GRAY_PRESSURE_PLATE));
        getOrCreateTagBuilder(HCItemTags.PLANK_BUTTONS).add(Item.fromBlock(HCColouredBlocks.GRAY_BUTTON));
        ...
        getOrCreateTagBuilder(HCItemTags.SHINGLES).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_SHINGLES));
        getOrCreateTagBuilder(HCItemTags.SHINGLE_STAIRS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_SHINGLE_STAIRS));
        getOrCreateTagBuilder(HCItemTags.SHINGLE_SLABS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_SHINGLE_SLAB));
        getOrCreateTagBuilder(HCItemTags.SHINGLE_WALLS).add(Item.fromBlock(HCColouredBlocks.LIGHT_GRAY_SHINGLE_WALL));
        getOrCreateTagBuilder(HCItemTags.SHINGLES).add(Item.fromBlock(HCColouredBlocks.GRAY_SHINGLES));
        getOrCreateTagBuilder(HCItemTags.SHINGLE_STAIRS).add(Item.fromBlock(HCColouredBlocks.GRAY_SHINGLE_STAIRS));
        getOrCreateTagBuilder(HCItemTags.SHINGLE_SLABS).add(Item.fromBlock(HCColouredBlocks.GRAY_SHINGLE_SLAB));
        getOrCreateTagBuilder(HCItemTags.SHINGLE_WALLS).add(Item.fromBlock(HCColouredBlocks.GRAY_SHINGLE_WALL));
