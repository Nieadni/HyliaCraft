...
public class HCLanguageProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(HCItems.FIERCE_TROUSERS, "Fierce Deity Trousers");
        translationBuilder.add(HCItems.FIERCE_BOOTS, "Fierce Deity Boots");
        translationBuilder.add("tooltip.hyliacraft.fierce_armor_0", "Legend has it this armor once belonged to the hero of a world in which the moon threatened to fall.");
        translationBuilder.add("tooltip.hyliacraft.fierce_armor_1", "When you wear it, you feel a fierce, godlike power flow through you.");
        translationBuilder.add(HCItems.HERO_CAP, "Cap of the Hero");
        translationBuilder.add(HCItems.HERO_TUNIC, "Tunic of the Hero");
        translationBuilder.add(HCItems.HERO_TROUSERS, "Trousers of the Hero");
        translationBuilder.add(HCItems.HERO_BOOTS, "Boots of the Hero");
        translationBuilder.add("tooltip.hyliacraft.hero_clothing_0", "Legend has it this armor was once cherished by a hero from ancient times.");
        translationBuilder.add("tooltip.hyliacraft.hero_clothing_1", "Its design is rather simple, but it's such a traditional look.");
        translationBuilder.add(HCItems.SKY_CAP, "Cap of the Sky");
        translationBuilder.add(HCItems.SKY_TUNIC, "Tunic of the Sky");
        translationBuilder.add(HCItems.SKY_TROUSERS, "Trousers of the Sky");
        translationBuilder.add(HCItems.SKY_BOOTS, "Boots of the Sky");
        translationBuilder.add("tooltip.hyliacraft.sky_clothing_0", "According to legend, this was once worn by a hero who appeared from the sky riding a mighty bird.");
        translationBuilder.add("tooltip.hyliacraft.sky_clothing_1", "Perfect for those who long to take to the skies.");
        translationBuilder.add(HCItems.TIME_CAP, "Cap of Time");
        translationBuilder.add(HCItems.TIME_TUNIC, "Tunic of Time");
        translationBuilder.add(HCItems.TIME_TROUSERS, "Trousers of Time");
        translationBuilder.add(HCItems.TIME_BOOTS, "Boots of Time");
        translationBuilder.add("tooltip.hyliacraft.time_clothing_0", "According to legend, this cap was once worn by a hero who traveled through time.");
        translationBuilder.add("tooltip.hyliacraft.time_clothing_1", "A truly timeless item perfect for kids and adults alike!");
        translationBuilder.add(HCItems.TWILIGHT_CAP, "Cap of Twilight");
        translationBuilder.add(HCItems.TWILIGHT_TUNIC, "Tunic of Twilight");
        translationBuilder.add(HCItems.TWILIGHT_TROUSERS, "Trousers of Twilight");
        translationBuilder.add(HCItems.TWILIGHT_BOOTS, "Boots of Twilight");
        translationBuilder.add("tooltip.hyliacraft.twilight_clothing_0", "According to legend, this was once worn by a hero who battled the monsters of twilight.");
        translationBuilder.add("tooltip.hyliacraft.twilight_clothing_1", "For one reason or another, it seems to smell of some beast...");
        translationBuilder.add(HCItems.WILD_CAP, "Cap of the Wild");
        translationBuilder.add(HCItems.WILD_TUNIC, "Tunic of the Wild");
        translationBuilder.add(HCItems.WILD_TROUSERS, "Trousers of the Wild");
        translationBuilder.add(HCItems.WILD_BOOTS, "Boots of Wild");
        translationBuilder.add("tooltip.hyliacraft.wild_clothing_0", "According to legend, this cap was crafted for a hero who travels the wild lands.");
        translationBuilder.add(HCItems.WIND_CAP, "Cap of the Wind");
        translationBuilder.add(HCItems.WIND_TUNIC, "Tunic of the Wind");
        translationBuilder.add(HCItems.WIND_TROUSERS, "Trousers of the Wind");
        translationBuilder.add(HCItems.WIND_BOOTS, "Boots of the Wind");
        ...
        generateRaceTranslations(translationBuilder, "gerudo", "Gerudo", "A semi reclusive race of folk who are generally found living in deserts.", "Slightly faster when walking on sand.");
