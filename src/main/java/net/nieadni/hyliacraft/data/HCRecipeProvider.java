...
public class HCRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.BLUE_CLAY_POT, 1)
                ...
                .offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.BROWN_CLAY_POT, 1)
                .input(HCBlocks.CLAY_POT)
                .input(Items.BROWN_DYE)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.CLAY_POT_WRITING, 1)
                ...
                .criterion("get_item", InventoryChangedCriterion.Conditions.items(HCBlocks.CLAY_POT))
                .offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.GERUDO_CLAY_POT, 1)
                .input(HCBlocks.CLAY_POT)
                .input(Items.YELLOW_DYE)
                .input(Items.BLACK_DYE)
                .criterion("get_item", InventoryChangedCriterion.Conditions.items(HCBlocks.CLAY_POT))
                .offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.GORON_CLAY_POT, 1)
                .input(HCBlocks.CLAY_POT)
                .input(Items.BLUE_DYE)
                .input(Items.YELLOW_DYE)
                .input(Items.BLACK_DYE)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.HATENO_CLAY_POT, 1)
                ...
                .criterion("get_item", InventoryChangedCriterion.Conditions.items(HCBlocks.CLAY_POT))
                .offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.KOKIRI_CLAY_POT, 1)
                .input(HCBlocks.CLAY_POT)
                .input(Items.ORANGE_DYE)
                .input(Items.LIME_DYE)
                .input(Items.YELLOW_DYE)
                .criterion("get_item", InventoryChangedCriterion.Conditions.items(HCBlocks.CLAY_POT))
                .offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.RITO_CLAY_POT, 1)
                .input(HCBlocks.CLAY_POT)
                .input(Items.GREEN_DYE)
                .input(Items.WHITE_DYE)
                .input(Items.ORANGE_DYE)
                ...
                .criterion("get_item", InventoryChangedCriterion.Conditions.items(HCBlocks.CLAY_POT))
                .offerTo(exporter);
        ShapelessRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, HCBlocks.ZORA_CLAY_POT, 1)
                .input(HCBlocks.CLAY_POT)
                .input(Items.BLUE_DYE)
                .input(Items.LIGHT_BLUE_DYE)
                .criterion("get_item", InventoryChangedCriterion.Conditions.items(HCBlocks.CLAY_POT))
