...
public class HCBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        getOrCreateTagBuilder(BlockTags.STAIRS).add(HCColouredBlocks.LIGHT_GRAY_BRICK_STAIRS);
        getOrCreateTagBuilder(BlockTags.SLABS).add(HCColouredBlocks.LIGHT_GRAY_BRICK_SLAB);
        getOrCreateTagBuilder(BlockTags.WALLS).add(HCColouredBlocks.LIGHT_GRAY_BRICK_WALL);
        getOrCreateTagBuilder(BlockTags.STAIRS).add(HCColouredBlocks.GRAY_BRICK_STAIRS);
        getOrCreateTagBuilder(BlockTags.SLABS).add(HCColouredBlocks.GRAY_BRICK_SLAB);
        getOrCreateTagBuilder(BlockTags.WALLS).add(HCColouredBlocks.GRAY_BRICK_WALL);
        ...
        getOrCreateTagBuilder(BlockTags.LOGS_THAT_BURN).add(HCColouredBlocks.LIGHT_GRAY_STRIPPED_LOG);
        getOrCreateTagBuilder(BlockTags.LOGS_THAT_BURN).add(HCColouredBlocks.LIGHT_GRAY_STRIPPED_WOOD);
        getOrCreateTagBuilder(BlockTags.WOODEN_STAIRS).add(HCColouredBlocks.LIGHT_GRAY_STAIRS);
        getOrCreateTagBuilder(BlockTags.WOODEN_SLABS).add(HCColouredBlocks.LIGHT_GRAY_SLAB);
        getOrCreateTagBuilder(BlockTags.WOODEN_FENCES).add(HCColouredBlocks.LIGHT_GRAY_FENCE);
        getOrCreateTagBuilder(BlockTags.FENCE_GATES).add(HCColouredBlocks.LIGHT_GRAY_FENCE_GATE);
        getOrCreateTagBuilder(BlockTags.PRESSURE_PLATES).add(HCColouredBlocks.LIGHT_GRAY_PRESSURE_PLATE);
        getOrCreateTagBuilder(BlockTags.WOODEN_BUTTONS).add(HCColouredBlocks.LIGHT_GRAY_BUTTON);

        getOrCreateTagBuilder(BlockTags.LOGS_THAT_BURN).add(HCColouredBlocks.GRAY_STRIPPED_LOG);
        getOrCreateTagBuilder(BlockTags.LOGS_THAT_BURN).add(HCColouredBlocks.GRAY_STRIPPED_WOOD);
        getOrCreateTagBuilder(BlockTags.WOODEN_STAIRS).add(HCColouredBlocks.GRAY_STAIRS);
        getOrCreateTagBuilder(BlockTags.WOODEN_SLABS).add(HCColouredBlocks.GRAY_SLAB);
        getOrCreateTagBuilder(BlockTags.WOODEN_FENCES).add(HCColouredBlocks.GRAY_FENCE);
        getOrCreateTagBuilder(BlockTags.FENCE_GATES).add(HCColouredBlocks.GRAY_FENCE_GATE);
        getOrCreateTagBuilder(BlockTags.PRESSURE_PLATES).add(HCColouredBlocks.GRAY_PRESSURE_PLATE);
        getOrCreateTagBuilder(BlockTags.WOODEN_BUTTONS).add(HCColouredBlocks.GRAY_BUTTON);
        ...
        getOrCreateTagBuilder(BlockTags.STAIRS).add(HCColouredBlocks.LIGHT_GRAY_SHINGLE_STAIRS);
        getOrCreateTagBuilder(BlockTags.SLABS).add(HCColouredBlocks.LIGHT_GRAY_SHINGLE_SLAB);
        getOrCreateTagBuilder(BlockTags.WALLS).add(HCColouredBlocks.LIGHT_GRAY_SHINGLE_WALL);
        getOrCreateTagBuilder(BlockTags.STAIRS).add(HCColouredBlocks.GRAY_SHINGLE_STAIRS);
        getOrCreateTagBuilder(BlockTags.SLABS).add(HCColouredBlocks.GRAY_SHINGLE_SLAB);
        getOrCreateTagBuilder(BlockTags.WALLS).add(HCColouredBlocks.GRAY_SHINGLE_WALL);
