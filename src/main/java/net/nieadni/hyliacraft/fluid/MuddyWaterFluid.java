...
public abstract class MuddyWaterFluid extends FlowableFluid {
    public Fluid getFlowing() {
        return HCFluids.FLOWING_MUDDY_WATER;
    }

    public Fluid getStill() {
        return HCFluids.MUDDY_WATER;
    }

    public Item getBucketItem() {
        return HCItems.MUDDY_WATER_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return HCBlocks.MUDDY_WATER.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == HCFluids.MUDDY_WATER || fluid == HCFluids.FLOWING_MUDDY_WATER;
    }
    ...
    public static class Still extends MuddyWaterFluid {
